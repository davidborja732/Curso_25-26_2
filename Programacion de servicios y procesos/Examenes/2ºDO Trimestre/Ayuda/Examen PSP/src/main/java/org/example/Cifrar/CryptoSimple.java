...
public class CryptoSimple {
    ...
    // Programa principal que ejecuta todo automáticamente
    public static void main(String[] args) throws Exception {

        // Archivo original a cifrar
        Path archivo = Path.of("archivo.txt");

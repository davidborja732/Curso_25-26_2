...
class student(models.Model):
    ...
    country_id2 = fields.Many2one('res.country', default=lambda self : self.env.ref('base.es'))
    province= fields.Many2one('res.country.state', domain="[('country_id','=',country_id2)]")
    ...
    _sql_constraints= [
        ...
        ('mayor_14', 'check(age>14)','El alumno debe tener por los menos 15 años')
    ]

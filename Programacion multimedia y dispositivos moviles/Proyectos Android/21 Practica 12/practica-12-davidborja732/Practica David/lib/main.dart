import 'package:aplicacion/screens/baloncesto_screen.dart';
import 'package:aplicacion/screens/lector_qr_screen.dart';
import 'package:aplicacion/screens/superhero_search_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        'baloncesto': (context) => HomeScreen(),
        'perretes': (context) => SuperHeroSearchScreen(),
      },
    );
  }
}
